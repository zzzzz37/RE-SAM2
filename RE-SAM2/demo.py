...
from dataloaders.datasets_demo import TestDataset
from dataloaders.dataset_specifics_demo import *
from utils import *
...
def config():
    ...
    all_supp = [0]  # CHAOST2: 0-4, CMR: 0-7
    batch_size = 1
...
if __name__ == "__main__":
    ...
    ###### Data configs ######
    DATASET = "CMR"  # CHAOST2 SABS CMR
    TRAIN_NAME = "RE_SAM2_demo"  # mri1 mri2 ct1 ct2 cmr
    ALL_EV = [0]  # [0,1,2,3,4]s
    TEST_LABEL = [1, 2, 3]
    dataset = DATASET
